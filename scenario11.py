...
class MyApp(QWidget):
    ...
    def doneAction11(self):
        ...
        if len(self.dataframe_refer) > 1048576:
            ...
            buttonReply = QMessageBox.information(self, "라인수 추출", "[중요성 금액: " + str(
                self.tempCost) + "] 라인수 " + str(len(self.dataframe) - 1) + "개입니다 <br> 추가 필터링이 필요해보입니다. <br> [전표번호 기준]",
                                                  QMessageBox.Ok)
        ...
        if buttonReply == QMessageBox.Ok: self.dialog11.activateWindow()
        ...
        if self.temp_Sheet == '':
            ...
            try:
                ...
                if ((self.checkC2.isChecked()) and (self.checkD2.isChecked())) or (
                    ...
                    self.temp_State = "'" + 'Credit' + "'" + "," + "'" + 'Debit' + "'"
                elif self.checkC2.isChecked(): self.temp_State = 'Credit'
                elif self.checkD2.isChecked(): self.temp_State = 'Debit'

                if ((self.checkC22.isChecked()) and (self.checkD22.isChecked())) or (
                    not (self.checkC22.isChecked()) and not (self.checkD22.isChecked())):
                    self.temp_State2 = "'" + 'Credit' + "'" + "," + "'" + 'Debit' + "'"
                elif self.checkC22.isChecked(): self.temp_State2 = 'Credit'
                elif self.checkD22.isChecked(): self.temp_State2 = 'Debit'
    ...
    def extButtonClicked11(self):
        ...
        if len(self.dataframe) > 1048576: self.communicate11.closeApp.emit()
