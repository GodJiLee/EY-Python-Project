...
       
        ...
        for n, i in enumerate(accountsname.AccountType.unique()):
            ...
            child_items = accountsname.AccountSubType[accountsname.AccountType == accountsname.AccountType.unique()[n]].unique()
            for m, x in enumerate(child_items):
                ...
                for o, y in enumerate(grandchild_items):
                    ...
                    self.new_tree.grandchild.setFlags(self.new_tree.grandchild.flags() | Qt.ItemIsTristate | Qt.ItemIsUserCheckable)
                    ...
                    for z in full_name:
                        ...
                        self.new_tree.grandgrandchild.setFlags(self.new_tree.grandgrandchild.flags() | Qt.ItemIsUserCheckable)
